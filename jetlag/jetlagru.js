        ...
        var A = k => {
            ...
            var we = D(ye, 2); {
                var be = z => {
                    ...
                    var U = D(ke, 2);
                    G((le, pe, Ke) => { O(y, `${le ?? ""} ${pe ?? ""}`), O(De, `${Ke ?? ""} `), Vt(U, "href", `rules/curses#${t.card.id}`) }, [() => b("curse-of"), () => b(`card.${t.card.id}.title`), () => b("casting-cost")]), L(z, te)
                };
